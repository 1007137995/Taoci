var WebGLInputField = {
 ...
 // var unityObjName="";
	//打开输入框
  ShowInputFieldDialog:function(defaultValue,isMultiLine){
      ...
      if(!document.getElementById("nativeInputDialog")) {
          ...
          var html = '<div id="nativeInputDialog" style="background:transparent; width:0%; height:0%; margin: 0; padding: 0; position: absolute; z-index:888;">' +
              '<textarea id="nativeInputDialogInput"  style="border: none; background: none; width:0; height:0;left: 0; top:0;color: white; outline: none; display: block; position: relative; font-size: 10px; " ></textarea>' +
              '</div>';
	  ...
	  document.getElementById("nativeInputDialog").style.display="";
	   document.getElementById("nativeInputDialogInput").style.opacity = 0;
	    document.getElementById("nativeInputDialogInput").style.visibility = "visible";
