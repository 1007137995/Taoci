...
namespace TinyTeam.UI
{
    ...
    public abstract class TTUIPage
    {
        ...
        protected EventTrigger.Entry initEntry(EventTriggerType type, UnityAction<BaseEventData> eventData)
        {
            UnityAction<BaseEventData> ed = new UnityAction<BaseEventData>(eventData);
            EventTrigger.Entry et = new EventTrigger.Entry();
            et.eventID = type;
            et.callback.AddListener(ed);
            return et;
        }
